...
# # Make folders if not already present 
 for (outcome in outcomes_to_test) {   
   ...
   base_dir <- "/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_Taxonomy/Species_results/5%_prev"
...
for (outcome in outcomes_to_test) {
  ...
  maaslin_results <-
    Maaslin2(
      ...
      output = paste(
        "/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_Taxonomy/Species_results/5%_prev/",
        outcome,
        "/",
        folder_names[folder],
        sep = ""),
