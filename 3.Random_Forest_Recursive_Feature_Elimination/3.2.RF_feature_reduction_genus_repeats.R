...
genus_names <- grep("genus_", names(data), value = TRUE)
presence_counts <- colSums(data[, genus_names] > 0)
cols_to_keep <- names(presence_counts)[presence_counts >= (0.05 * nrow(data))]

cat("Total genus columns:", length(genus_names), "\n")
cat("Genera present in ≥5% of samples:", length(cols_to_keep), "\n")

data <- data %>%
  select(-all_of(genus_names)) %>%
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Any_neoplasia_species_RF_results.xlsx")
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Cancer_detected_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Advanced_neoplasia_exc_cancer_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Non_advanced_neoplasia_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Only_adenoma_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
cat("Total genus columns:", length(species_names), "\n")
cat("Genera present in ≥5% of samples:", length(cols_to_keep), "\n")
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Only_serrated_lesions_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Only_ssl_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/genera_imp_features/Advanced_neoplasia_(inc_cancer)_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
