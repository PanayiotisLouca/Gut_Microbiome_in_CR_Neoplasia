...
species_names <- grep("species_", names(data), value = TRUE)
presence_counts <- colSums(data[, species_names] > 0)
cols_to_keep <- names(presence_counts)[presence_counts >= (0.05 * nrow(data))]

cat("Total species columns:", length(species_names), "\n")
cat("Species present in ≥5% of samples:", length(cols_to_keep), "\n")
...
# save results  
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Any_neoplasia_species_RF_results.xlsx")
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Cancer_detected_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Advanced_neoplasia_exc_cancer_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Non_advanced_neoplasia_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Only_adenoma_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Only_serrated_lesions_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Only_ssl_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
...
# save results 
path <- file.path("/Users/panayiotislouca/Documents/NCL_files/COLO-COHORT/Gut_microbiome_work/phase1_analysis/P1_covariate_feature_reduction/species_imp_features/Advanced_neoplasia_(inc_cancer)_species_RF_results.xlsx")
writexl::write_xlsx(final_results,
                    path)
